...
import vtkVolumeColorPresets from './vtkVolumePresets.js';

function getShiftRange(colorTransferArray) {
  // Shift range to RGB/opacity range centered around 0. Refer to Paraview-Glance.
...
function applyVtkColorPreset(actor, preset, options) {
  // Create and apply a color transfer function
  options = options || {};
  ...
  // Retrieve gradient min/max and min/max opacity values from preset
  const [
    gradientMinValue,
    gradientMinOpacity,
    gradientMaxValue,
...
export default applyVtkColorPreset;
export {
  getShiftRange,
