...
import {
  SegmentationData, SegmentationRepresentation,
} from '../services/SegmentationService/SegmentationService';
import { useSystem } from '@ohif/core';
const excludedModalities = ['SM', 'OT', 'DOC', 'ECG'];


export function mapSegmentationToDisplay(segmentation, customizationService) {
...
export function useViewportSegmentations({
  ...
  const { segmentationService, viewportGridService, customizationService, displaySetService } = servicesManager.services;
