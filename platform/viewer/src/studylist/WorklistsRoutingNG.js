...
import WorkListPageNG from '../pages/WorkListPageNG/WorkListPageNG';

const { DicomMetadataStore } = OHIF;


export default function WorklistsRoutingNG() {
  ...
  useEffect(() => {
    console.log('[viewer:worklists:route-init] component mounted')

    return () => {
      console.log('[viewer:worklists:route-init] component unmounted');
