  ...
  function f(n, t) {
    ...
    return (
      ...
      (e.l = function () {
        var n = e.m,
          t = n.installing;
        e.i > 0 || !o(t.scriptURL, e.g) || performance.now() > e.v + 6e4
          ? ((e.p = t), n.removeEventListener('updatefound', e.l))
          : ((e.P = t), e.h.add(t), e.o.resolve(t)),
          ++e.i,
          t.addEventListener('statechange', e.S);
      }),
      (e.S = function (n) {
        var t = e.m,
          r = n.target,
          ...
          o = r === e.p,
          a = o ? 'external' : '',
          c = { sw: r, originalEvent: n };
        !o && e.j && (c.isUpdate = !0),
          e.dispatchEvent(new u(a + i, c)),
          'installed' === i
            ? (e.A = self.setTimeout(function () {
                'installed' === i && t.waiting === r && e.dispatchEvent(new u(a + 'waiting', c));
              }, 200))
            : 'activating' === i && (clearTimeout(e.A), o || e.u.resolve(r));
      }),
      (e.O = function (n) {
        var t = e.P;
        t === navigator.serviceWorker.controller &&
          (e.dispatchEvent(new u('controlling', { sw: t, originalEvent: n, isUpdate: e.j })), e.s.resolve(t));
      }),
      (e.U =
        ((c = function (n) {
          var t = n.data,
      ...
      (e.g = n),
      (e.t = t),
      navigator.serviceWorker.addEventListener('message', e.U),
      e
    );
  }
    ...
    (m.register = function (n) {
      ...
      try {
        ...
        return (function (n, t) {
          ...
          function () {
            return (
              (e.j = Boolean(navigator.serviceWorker.controller)),
              (e.I = e.M()),
              a(e.R(), function (n) {
                (e.m = n),
                  e.I &&
                    ...
                    e.u.resolve(e.I),
                    e.s.resolve(e.I),
                    e.I.addEventListener('statechange', e.S, { once: !0 }));
                var t = e.m.waiting;
                return (
                  t &&
                    o(t.scriptURL, e.g) &&
                  ...
                  navigator.serviceWorker.addEventListener('controllerchange', e.O, { once: !0 }),
                  e.m
                );
              })
            );
