(this.workbox = this.workbox || {}),
  (this.workbox.googleAnalytics = (function (t, o, e, n, a, c, r, w, s) {
    ...
    return (
      (t.initialize = (t = {}) => {
        const n = e.cacheNames.getGoogleAnalyticsName(t.cacheName),
          a = new o.BackgroundSyncPlugin('workbox-google-analytics', {
                ...
                for (; (o = await t.shiftRequest()); ) {
                  ...
                  try {
                    ...
                    if ((t.set('qt', String(r)), c.parameterOverrides))
                      for (const o of Object.keys(c.parameterOverrides)) {
