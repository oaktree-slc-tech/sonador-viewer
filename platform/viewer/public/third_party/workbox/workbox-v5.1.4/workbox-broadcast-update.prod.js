(this.workbox = this.workbox || {}),
  (this.workbox.broadcastUpdate = (function (t, a, o, s) {
    ...
    const e = (t, a, o) =>
      ...
      n = ['content-length', 'etag', 'last-modified'],
      i = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
    function c(t) {
      return { cacheName: t.cacheName, updatedURL: t.request.url };
    }
    class r {
      constructor({ headersToCheck: t, generatePayload: a } = {}) {
        (this.t = t || n), (this.o = a || c);
      }
      async notifyIfUpdated(t) {
        if (t.oldResponse && !e(t.oldResponse, t.newResponse, this.t)) {
          const s = {
            type: 'CACHE_UPDATED',
