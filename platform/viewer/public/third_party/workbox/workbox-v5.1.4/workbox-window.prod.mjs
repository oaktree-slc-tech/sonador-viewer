...
class h extends class {
  ...
  constructor(t, h = {}) {
    super(),
      ...
      (this.m = () => {
        const t = this.p,
          s = t.installing;
        this.h > 0 || !i(s.scriptURL, this.S) || performance.now() > this.u + 6e4
      ...
      (this.P = (t) => {
        ...
        !n && this.W && (r.isUpdate = !0),
          ...
          'installed' === h
            ...
            : 'activating' === h && (clearTimeout(this.B), n || this.g.resolve(i));
      }),
      (this.C = (t) => {
        const s = this._;
        s === navigator.serviceWorker.controller &&
          (this.dispatchEvent(new e('controlling', { sw: s, originalEvent: t, isUpdate: this.W })), this.l.resolve(s));
      }),
      (this.R = async (t) => {
  ...
  async register({ immediate: t = !1 } = {}) {
    t || 'complete' === document.readyState || (await new Promise((t) => window.addEventListener('load', t))),
    ...
    return (
      ...
      navigator.serviceWorker.addEventListener('controllerchange', this.C, { once: !0 }),
      this.p
    );
  }
  async update() {
