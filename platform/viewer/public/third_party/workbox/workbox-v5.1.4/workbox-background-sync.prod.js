(this.workbox = this.workbox || {}),
  (this.workbox.backgroundSync = (function (t, e, s, i, n) {
    ...
    class a {
      constructor(t) {
        (this.t = t),
          (this.s = new n.DBWrapper('workbox-background-sync', 3, {
      ...
      i(t) {
        ...
        t.oldVersion > 0 &&
          t.oldVersion < 3 &&
          e.objectStoreNames.contains('requests') &&
          e.deleteObjectStore('requests');
        e.createObjectStore('requests', {
          autoIncrement: !0,
          keyPath: 'id',
        }).createIndex('queueName', 'queueName', { unique: !1 });
      }
    }
    const r = [
      'method',
    ...
    class o {
      ...
      async k({ request: t, metadata: e, timestamp: s = Date.now() }, i) {
        const n = {
