// Metadata provider for OHIF based on Cornerstone v4 and Cornerstone Tools (Legacy/Classic).
// Kept for reference and to maintain compatibility for older OHIF v4 integrated systems 
// in the Sonador Viewer.
...
import {  fetchPaletteColorLookupTableData } from '../utils/metadataProvider/fetchCornerstonePaletteColorLookupTableData';
...
class MetadataProvider {
  ...
  async addInstance(dicomJSONDatasetOrP10ArrayBuffer, options = {}) {
    // Add instance to the metadata provider

    // Add instance to the OHIF v3 DICOM Meta Store service to enable interability
    // between Sonador Viewer (OHIF v2.5) and Cornerstone 3D
