...
export default function retrieveStudiesMetadata(server, studyInstanceUIDs, filters, separateSeriesInstanceUIDFilters=false, options) {
  /**
  ...
  *   - force_fetch (bool, default=false): force a reload of study metadata from the server
  * 
  ...
  */
  ...
  studyInstanceUIDs.forEach(function (StudyInstanceUID) {
    ...
    const promise = retrieveStudyMetadata(server, StudyInstanceUID, filters, separateSeriesInstanceUIDFilters, options);
