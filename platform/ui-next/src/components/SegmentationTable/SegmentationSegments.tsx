          ...
          {segments.map(segment => {
            ...
            const DataRowComponent = (
              <DataRow
                ...
                onColor={onSegmentColorClick ? () => onSegmentColorClick(segmentation.segmentationId, segmentIndex) : undefined}
                onToggleVisibility={onToggleSegmentVisibility ? () => onToggleSegmentVisibility(segmentation.segmentationId, segmentIndex, representation.type) : undefined}
                onToggleLocked={onToggleSegmentLock ? () => onToggleSegmentLock(segmentation.segmentationId, segmentIndex) : undefined}
                onSelect={onSegmentClick ? () => onSegmentClick(segmentation.segmentationId, segmentIndex) : undefined}
                onRename={onSegmentEdit ? () => onSegmentEdit(segmentation.segmentationId, segmentIndex) : undefined}
                onDelete={onSegmentDelete ? () => onSegmentDelete(segmentation.segmentationId, segmentIndex) : undefined}
