...
export const SegmentationTableConfig: React.FC<{ children?: React.ReactNode }> = ({ children }) => {
  ...
  const {
    ...
    data,
    showInactiveSegmentationControls=true, fillAlphaStep=0.1, outlineWidthStep=1,
  ...
  return (
    <div className="bg-muted mb-0.5 space-y-2 rounded-b px-1.5 pt-0.5 pb-3 seg-table-config">
      ...
      {showInactiveSegmentationControls && (<>
