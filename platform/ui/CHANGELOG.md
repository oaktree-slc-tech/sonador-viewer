...
- throttle thumbnail progress updates ([#2557](https://github.com/OHIF/Viewers/issues/2557))
  ([66c587b](https://github.com/OHIF/Viewers/commit/66c587b139835201331a64bc24a17901e7583649))
...
- Reordered definitions in providers to prevent uninitialized var access
  ([#2108](https://github.com/OHIF/Viewers/issues/2108))
  ([619f361](https://github.com/OHIF/Viewers/commit/619f3615109d6cc4c69ff2f9fedbf83bd9309719))
...
- rendering delete button when text is too wide for parent div ([#1526](https://github.com/OHIF/Viewers/issues/1526))
...
- Lesion tracker right panel ([#1428](https://github.com/OHIF/Viewers/issues/1428))
...
- measurements panel css and delete button visibility ([#1352](https://github.com/OHIF/Viewers/issues/1352))
...
- allow empty values for dimensions ([#1295](https://github.com/OHIF/Viewers/issues/1295))
...
- Fix display issues with incorrect thumbnails. Change ImageThumb to functional component.
  ([#1148](https://github.com/OHIF/Viewers/issues/1148))
...
- **StudyList:** camel case colSpan ([#1123](https://github.com/OHIF/Viewers/issues/1123))
...
- Move Series Information to Separate Row ([#990](https://github.com/OHIF/Viewers/issues/990))
...
- Address issues with touch devices and drag/drop causing crashes ([#982](https://github.com/OHIF/Viewers/issues/982))
...
- Use HTML5Backend for drag-drop if the device does not support touch
  ([#927](https://github.com/OHIF/Viewers/issues/927)) ([6fdac4d](https://github.com/OHIF/Viewers/commit/6fdac4d))

# [0.51.0](https://github.com/OHIF/Viewers/compare/@ohif/ui@0.50.4...@ohif/ui@0.51.0) (2019-09-12)

### Features

- **EraserTool:** add eraserTool to @ohif/extension-cornerstone ([#912](https://github.com/OHIF/Viewers/issues/912))
